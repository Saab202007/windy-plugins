...
function () {
  ...
  var points = [['Yaşma', 'city-2', 49.39, 41.689], ['Xızı-2', 'city-2', 49.38, 41.7], ['Xızı-3', 'city-3', 49.375, 41.71], ['Qobustan', 'city-3', 48.81, 41.0], ['Pereküşkül', 'city-1', 49.2857, 40.2], ['Area-7', 'city-2', 49.0, 39.9]];
  var markers = null;
  var icon = L.divIcon({
